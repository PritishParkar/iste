  ...
  <nav class="fixed w-full md:p-3 bg-transparent p-4 font-sans md:px-32 px-8" style="background: rgba(255, 255, 255, 0.9)">
    <div class="flex items-center justify-between">
      ...
      <div class="md:hidden">
        <button @click="drawer">
          <svg
            class="h-8 w-8 fill-current textblack"
            fill="none"
      ...
      <div class="hidden md:block text-black">
        <ul class="flex space-x-8 text-base">
          <li>
            <NuxtLink to="/" :class="activeMenuForHome">Home</NuxtLink>
          </li>
          <li>
          ...
          <li>
            <NuxtLink to="/login"
              class="
                cta
                bg-gradient-to-r
                hover:from-white hover:to-white hover:text-red-500
                from-pink-500
                to-yellow-500
                px-3
                py-2
